...
# %%
def create_pathway_gene_dataframe(kegg_gene_path='raw/KEGG_Identifiers_gene_name_pathway_fixed_v1.txt',
                                  kegg_pathway_path='raw/kegg_pathway_protein_associations_1.tsv',
                                  export_path='processed/pathway_gene_merged.pkl'):
    """
    Creating pathway sorted gene dataframe
    :param kegg_gene_path: Path of dataset containing gene and kegg_id
    :param kegg_pathway_path: Path of dataset containing pathway and kegg_id
...
def create_drug_cell_dataframe(drug_cell_path=
                               'raw/GDSC_338K_drug_response_and_cansyl_drug_cell_line_pairs_concatenated.txt',
                               drug_smiles_path='raw/GDSC_drug_name_SMILES_and_ECFP4_v2.txt'):
    """
...
# %%
def create_dataset(cell_lines_path='raw/full/',
...
# %%
def create_l1000_dataset(cell_lines_path='raw/full/',
                         l1000_genes_path='raw/L1000_gene_list.txt',
...
# %%
def create_pathway_sorted_dataset(cell_lines_path='raw/full/',
                                  export_path='processed/dataset_pathway_sorted.pkl'):
    """
...
# %%
def create_pathway_sorted_reduced_dataset(cell_lines_path='raw/full/',
                                          export_path='processed/dataset_pathway_sorted_reduced.pkl'):
    """
...
def create_tissue_dataset(tissue_name):
    ...
    """
    cell_line_tissue_paired = pd.read_csv('raw/GDSC_986_cell_lines_matched_with_TCGA_tissue_names.txt',
                                          sep='\t')
