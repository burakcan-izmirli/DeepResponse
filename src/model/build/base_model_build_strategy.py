...
class BaseModelCreationStrategy(ABC):
    ...
    def create_conv_model(self, cell_line_dims):
        ...
        x = keras.layers.Conv2D(ConvolutionalModel.conv_1.filters, ConvolutionalModel.conv_1.kernel_size, activation='relu')(input_layer)
        x = keras.layers.BatchNormalization()(x)

        # Second convolutional layer with batch normalization
        x = keras.layers.Conv2D(ConvolutionalModel.conv_2.filters, ConvolutionalModel.conv_2.kernel_size, activation='relu')(x)
        x = keras.layers.BatchNormalization()(x)
