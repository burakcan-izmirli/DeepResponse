...
# %%
def create_pathway_gene_dataframe(kegg_gene_path='data/raw/KEGG_Identifiers_gene_name_pathway_fixed_v1.txt',
                                  kegg_pathway_path='data/raw/kegg_pathway_protein_associations_1.tsv',
                                  export_path='data/processed/pathway_gene_merged.pkl'):
    """
...
def create_drug_cell_dataframe(drug_cell_path=
                               'data/raw/GDSC_338K_drug_response_and_cansyl_drug_cell_line_pairs_concatenated.txt',
                               drug_smiles_path='data/raw/GDSC_drug_name_SMILES_and_ECFP4_v2.txt'):
    """
    Creating dataframe contains drug_name, cell_line_name, smiles and pic50
    :param drug_cell_path: Path of drug-cell pairs data
    :param drug_smiles_path: Path of drug-smiles pairs data
    """
...
# %%
def create_dataset(cell_lines_path='data/raw/full/',
                   export_path='data/processed/dataset.pkl'):
    """
    Creating data using all genes and without any pathway or tissue information
    :param cell_lines_path: Path of cell line features data
    :param export_path: Export path
    :return: data
    """
...
# %%
def create_l1000_dataset(cell_lines_path='data/raw/full/',
                         l1000_genes_path='data/raw/L1000_gene_list.txt',
                         export_path='data/processed/dataset_l1000.pkl'):
    """
    Creating data only contains L1000 genes.
...
# %%
def create_pathway_sorted_dataset(cell_lines_path='data/raw/full/',
                                  export_path='data/processed/dataset_pathway_sorted.pkl'):
    """
    Creating pathway sorted data
    :param cell_lines_path: Path of cell line features
    :param export_path: Export path
...
# %%
def create_pathway_sorted_reduced_dataset(cell_lines_path='data/raw/full/',
                                          export_path='data/processed/dataset_pathway_sorted_reduced.pkl'):
    """
    Creating pathway sorted data only contains genes with pathway information.
    :param cell_lines_path: Path of cell line features
    :param export_path: Export path
...
def create_tissue_dataset(tissue_name):
    """
    Creating tissue data
    :param tissue_name: Tissue name e.g digestive_system
    :return Tissue data
    """
    cell_line_tissue_paired = pd.read_csv('../../data/raw/GDSC_986_cell_lines_matched_with_TCGA_tissue_names.txt', sep='\t')
    ...
    tissue_filtered_dataset.to_pickle(f"data/processed/dataset_tissue_{tissue_name}.pkl")
